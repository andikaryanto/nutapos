...
<body>
    ...
    <div class="error">
        ...
        <div class="error__description">The page you are looking for is not found :(</div>
        <button id="home" onclick="toHome('<?= $homeUrl ?>')" class="error__button error__button--active">HOME</button>
    </div>
